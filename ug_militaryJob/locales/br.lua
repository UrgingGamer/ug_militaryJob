Locales['br'] = {
  ...
  -- Roupas Customs--
  ['fardapsp1'] = 'PSP - Farda de Patrulhamento I',
  ['fardapspdefault'] = 'PSP - Farda Default',
  ['fardagoe1'] = 'PSP - Farda da GOE I',
  -- Default --
  ['gilet_wear'] = 'PSP - Colete de Trânsito',
  ['bullet_wear'] = 'PSP - Colete Anti-Bala',
  ['no_outfit'] = 'there\'s no uniform that fits you!',
  ['open_cloackroom'] = 'Pressione ~INPUT_CONTEXT~ para se trocar',
  
  -- Separadores (By: UrgingGamer) --
  ['psppatrulha'] = '-=-[PSP - Patrulhamento]-=-',
  ['pspoutros'] = '-=-[PSP - Outros]-=-',
  ['pspfardadefault'] = '-=-[PSP - Farda Default]-=-',
  ['pspgoe'] = '-=-[PSP - GOE]-=-',
